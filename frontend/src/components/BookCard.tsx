...
export default function BookCard(props: { book: TBook }) {
    return (
        <Link to={'/' + props.book.id} className="rounded-2xl w-60 h-[450px] m-5 cursor-pointer">
            ...
            <img src="https://edit.org/images/cat/book-covers-big-2019101610.jpg" className="w-full rounded-md object-cover h-[300px]  hover:h-[350px] transition-all duration-100" alt="" />
