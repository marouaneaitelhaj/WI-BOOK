...
export default function BookCard(props: { book: TBook }) {
    ...
    return (
        <Link to={'/books/' + props.book.id} className="rounded-2xl w-60 h-[450px] m-5 cursor-pointer">
            ...
            <img src={getRandomPict(props.book.id)} className="w-60 rounded-md object-cover h-[300px]  hover:h-[350px] transition-all duration-300" alt="" />
